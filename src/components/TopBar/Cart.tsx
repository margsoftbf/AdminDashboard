									...
									<div className='flex h-full flex-col overflow-y-scroll bg-white shadow-xl'>
										...
										<div className='border-t border-gray-200 px-4 py-6 sm:px-6'>
											...
											<div className='mt-6'>
												<a
													href='#'
													className='flex items-center justify-center rounded-md border border-transparent bg-lightViolet px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-darkViolet'
												>
													Checkout
												</a>
											</div>
